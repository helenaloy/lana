...
export default function WhyUs() {
  ...
  return (
    <div className="rounded-2xl bg-gradient-to-br from-primary-50 to-primary-100 p-8 md:p-12">
      <h2 className="mb-4 text-center font-display text-3xl font-bold text-gray-900 md:text-4xl">
        {t('title')}
      </h2>
        ...
        {reasons.map((reason, index) => (
          ...
          >
            <div className="mb-3 flex items-center">
              ...
              <h3 className="font-heading text-xl font-bold text-gray-900">{reason.title}</h3>
            </div>
